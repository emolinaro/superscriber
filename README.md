...
- Transcript-first casefile media transport with a decoded waveform as the seek surface, click-to-play transcript segments, and a collapsible video picture. See [The player](./docs/USER-GUIDE.md#the-player) for reviewer controls and [Casefile review](./DESIGN.md#casefile-review) for the precise layout and follow-scroll contract
