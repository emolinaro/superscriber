...
- Phone safety mode (below 768 px width, or coarse pointer with height below 768 px): read-only casefile and administration, semantic ledger lists, compact viewport-pinned transport, governance accordions, supported ingest; the app bar, emergency banner, and case header flow away and no governed action bar is shown
