<p align="center">
  <img src="/superscriber/img/icon.svg" alt="Superscriber logo" width="96" height="96" />
</p>
...
- Optional institutional sign-in via Authentik OIDC (local, dual, or authentik-primary deployment modes) with live-revocable server-side sessions and a management-boundary break-glass account - operator runbooks in [`docs/operators/`](https://github.com/emolinaro/superscriber/tree/main/docs/operators)
...
- [`app/`](https://github.com/emolinaro/superscriber/tree/main/app) — Next.js app routes and APIs
- [`src/components/`](https://github.com/emolinaro/superscriber/tree/main/src/components) — UI components grouped by surface (auth, work inbox, ingest, casefile, administration, shell)
- [`src/domain/`](https://github.com/emolinaro/superscriber/tree/main/src/domain) — domain models and workflow rules
- [`src/server/`](https://github.com/emolinaro/superscriber/tree/main/src/server) — auth, access, persistence, ingest, orchestration, casefile, and work-inbox logic
- [`data/`](https://github.com/emolinaro/superscriber/tree/main/data) — local SQLite data, secrets, temp uploads, and media files
- [`worker/`](https://github.com/emolinaro/superscriber/tree/main/worker) — internal Python transcription worker
- [`scripts/`](https://github.com/emolinaro/superscriber/tree/main/scripts) — container/runtime helpers and operator auth commands (identity import, session revoke, break-glass)
...
- [`docs/operators/`](https://github.com/emolinaro/superscriber/tree/main/docs/operators) - operator runbooks for Authentik OIDC deployment, identity linking, break-glass, the no-mail profile, and auth outage and rollback
...
This project is licensed under the MIT License. See [LICENSE](https://github.com/emolinaro/superscriber/blob/main/LICENSE).
